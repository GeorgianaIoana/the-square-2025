...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    ro: {
      ...
      'banner.subtitle1': 'Șahul este viața în miniatură. - Garry Kasparov',
      ...
      'services.adults.freeSession': 'prima ședință este cadoul nostru pentru tine',
      ...
      'services.kids.freeSession': 'prima ședință este cadoul nostru pentru tine',
      'services.kids.siblingDiscount': '20% reducere pentru frați',
      ...
      'services.individualKids.price': 'de la 120 lei',
      ...
      'services.individualKids.siblingDiscount': '20% reducere pentru frați',
      'services.individualAdults.title': 'Curs individual adulți',
      'services.individualAdults.price': 'de la 150 lei',
    ...
    en: {
      ...
      'banner.subtitle1': 'Chess is life in miniature. — Garry Kasparov',
      ...
      'services.adults.freeSession': 'the first session is our gift to you',
      ...
      'services.kids.freeSession': 'the first session is our gift to you',
      'services.kids.siblingDiscount': '20% discount for siblings',
      ...
      'services.individualKids.price': 'from 120 RON',
      ...
      'services.individualKids.siblingDiscount': '20% discount for siblings',
      'services.individualAdults.title': 'Private Lessons for Adults',
      'services.individualAdults.price': 'from 150 RON',
