  ...
  return (
    ...
    >
      <div className="sm:container mx-auto">
        {/* Titlu */}
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#a6b6e0] mb-16">
          Contact Us
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[500px] items-start">
          ...
          <div className="flex flex-col gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-[#a6b6e0]">
                Get in Touch
              </h3>
              <div className="space-y-4 text-sm sm:text-base">
                <p className="flex items-center text-[#a6b6e0]">
                  <Mail className="w-5 h-5 mr-2" />
                  info@masterchess.com
                </p>
                <p className="flex items-center text-[#a6b6e0]">
                ...
                <p className="flex items-center text-[#a6b6e0]">
                  ...
                  Str. Coreni 34, București, Sector 2
                </p>
                <p className="text-[#a6b6e0]">
                  Sprijină activitatea educativă a clubului de șah ACS THE SQUARE
                </p>
                <p className="text-[#a6b6e0]">Persoane juridice</p>
                <p className="text-[#a6b6e0]">Persoane fizice</p>
              </div>
            </div>
          ...
          <div className="w-full max-w-xl bg-[#a6b6e0] rounded-xl shadow-xl px-6 sm:px-10 py-10 sm:py-16 mx-auto">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <input type="hidden" name="access_key" value="9e26e303-368c-44fc-86ac-7e427470a472" />

              <div className="text-center mb-6">
                <h5 className="text-xl sm:text-2xl font-semibold text-[#233d36]">
                  Contact Form
                </h5>
              </div>
              ...
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-medium text-[#badad5] mb-1"
                >
              ...
              {/* Feedback result */}
              {result && (
                <p className="text-center text-sm text-green-700 pt-4">{result}</p>
              )}
            </form>
          </div>
        </div>
