const WhatsAppButton = () => {
  return (
    <div
      className="fixed bottom-4 left-16 sm:bottom-6 sm:left-20 z-50"
      id="shop_whatsapp_number"
    >
      <a
        href="https://wa.me/+40742898793?text=Bună!"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center justify-center bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all duration-300 cursor-pointer"
      >
        <svg
          height="20px"
          width="20px"
