const WhatsAppButton = () => {
  return (
    <div className="fixed bottom-4 right-4 z-50" id="shop_whatsapp_number">
      <a
        href="https://wa.me/+40742898793?text=Bună!"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all duration-300 cursor-pointer"
      >
        <svg
          height="20px"
          width="20px"
